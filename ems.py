...
def add_employee():
    if idEntry.get()=='' or phoneEntry.get()=='' or nameEntry.get()=='' or salaryEntry.get()=='':
        ...
        messagebox.showerror('Error' , "Invalid Id formate. Use 'EMP' followed by a number(e.g. , 'EMP1').")
...
# GUI
window = CTk()
window.geometry('978x620+100+100')
window.resizable(False,False) # we 0 , 0 or False , False both are working
window.title('Employee Management System')
window.configure(fg_color='#161C30')

# Logo img 
logo = CTkImage(Image.open('img3-transformed.jpeg'),size=(978 , 210 ))
